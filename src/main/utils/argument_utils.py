...
def _build_program_argument_parser(title: str, description: str) -> ArgumentParser:
    ...
    parser.add_argument('-gas', '--gradient-accumulation-steps', help="Gradient accumulation steps(default: 0)", type=int, default=0)
    ...
    parser.add_argument('-msl', '--max-seq-length', help="The maximum sequence length to use for the Dataset(default: the smaller of the `tokenizer.model_max_length` and `1024`)", type=lambda x: _parse_nullable_int_arg(x), default="None")
